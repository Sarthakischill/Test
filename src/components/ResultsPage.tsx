...
export const ResultsPage = () => {
  ...
  const chartOptions = {
    ...
    responsive: true,
    maintainAspectRatio: false, // Allow chart to take container's height
    plugins: {
      legend: {
        display: false,
      },
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <div className="h-full relative"> {/* Ensure chart takes up available height */}
                <Bar data={chartData} options={chartOptions} height={300}/> {/* Adjust height as needed */}
              </div>
            </motion.div>
              ...
              {recommendations.map((recommendation, index) => (
                ...
                >
                  ...
                  <div className="border-t pt-3 mt-2">
                    <h3 className="font-medium text-gray-900 mb-2 text-md">Why this course?</h3>
                    <ul className="space-y-1">
                      {recommendation.details.map((detail, i) => (
                        <li key={i} className="text-gray-600 text-sm list-disc ml-5">
                          {detail}
                        </li>
                      ))}
                    </ul>
